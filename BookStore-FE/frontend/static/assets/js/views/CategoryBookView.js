...
export default class TypeBookView extends Abstract {
                    ...
                    <div class="book-card">
                        ...
                        <div class="wrap-book-info">
                            <div class="book-price">
                                ...
                                <div class="sale-wrap">
                                    <div class="old-price">${item.salePrice.toLocaleString()}d</div>
    ...
    async renderBooksFilterList() {
        ...
        const listBooks = data.map(item => this.renderBookFilterItem(item)).join('');
        return listBooks;
    }
                ...
                <div class="types-book-list col-lg-10">
                    <div class="heading-types-list">
                        ...
                        <div class="heading-types-sort">
                            ...
                            <span><button class="btn-sort" data-sort="price" data-direction="ASC" type="button">Giá tăng dần</button></span>
                            <span><button class="btn-sort" data-sort="price" data-direction="DESC" type="button">Giá giảm dần</button></span>
                        </div>
                    </div>
